  ...
  return (
    <div className={`backdrop-blur-sm rounded-lg p-8 transition-colors duration-1000`}>
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 justify-center">
        {/* Image on Left */}
        <div className="relative w-95 h-64 flex-shrink-0 rounded-2xl overflow-hidden shadow-lg">
          <Image
            src="/jodi.JPG"
            alt="Contact"
            fill
        ...
        {/* Description and Links on Right */}
        <div className="flex flex-col justify-center">
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            I'm Jodi, and I like to code. Reach me here:
          </p>
